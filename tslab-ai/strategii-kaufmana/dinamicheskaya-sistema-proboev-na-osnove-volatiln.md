...
<<<<<<< Updated upstream
Специального авторского блока расчёта размера позиции в текущей реализации не добавлялось. Используется стандартная схема сервера TSLab без отдельного пользовательского риск-блока.
