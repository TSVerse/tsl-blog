...
3. В дереве папок раскройте **Академия TSLab** -> **Примеры скриптов Kaufman**. Выберите скрипт **Пробой первого часа** и нажмите **Download**.

![](./proboy-pervogo-chasa.png){width=1150px height=673px}

### Способ 2. Загрузка из файла

1. Скачайте файл скрипта: [TSM 1st Hour Breakout (S).tscript](<TSM 1st Hour Breakout (S).tscript>)
