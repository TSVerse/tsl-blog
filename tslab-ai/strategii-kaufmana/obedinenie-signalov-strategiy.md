...
Стратегия **всегда находится в рынке** (либо длинная, либо короткая позиция). Она берёт сигналы от **двух независимых систем** и торгует только тогда, когда **обе системы согласны** с направлением сделки.
...
Пользователь может выбрать для **System 1** и **System 2** один из четырёх типов сигналов:
...
### Описание стратегии CODEX GPT-5.4
