...
|---------------|---------------------------|------------------------|
| Period ADX    | Период расчёта индикатора | 14                     |
| ADX Threshold | Порог входа в позицию     | 25                     |
| Stop Loss %   | Размер стоп-лосса         | 2%                     |
| Take Profit % | Размер тейк-профита       | 5%                     |

<note type="danger">

Параметр **Stop Loss %** не рекомендуется изменять без понимания рисков!
...
2. Убедитесь, что значение ADX выше порога входа (параметр ADX Threshold)

3. Проверьте, что на счету достаточно средств для открытия минимальной позиции

4. Посмотрите логи в окне "Сообщения" -- там могут быть ошибки подключения к бирже
...
-  Отключайте робота во время выхода важных новостей (если стратегия не учитывает фундаментал)
...
Присоединяйтесь к обсуждению в нашей группе Telegram: <https://t.me/tslabprorugroup>

Техническая поддержка:

Все вопросы направляйте в службу поддержки: <https://support.tsverse.pro>

Ваши отзывы и предложения помогают нам делать TSLab лучше!